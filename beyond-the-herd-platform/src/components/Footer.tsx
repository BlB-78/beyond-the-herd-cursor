...
export function Footer() {
  ...
  return (
    <footer className="bg-[#0b0f19] pt-16 pb-8 border-t border-white/5" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
          ...
          <Link to="/" className="flex items-center gap-3">
            <img src={logo} alt="Beyond The Herd Logo" className="w-8 h-8 object-cover rounded-md grayscale opacity-80" />
            <span className="font-bold text-xl tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600">
              Beyond The Herd
            </span>
          </Link>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col items-center justify-center text-center">
          <p className="text-[#8B949E] text-sm mb-3 font-medium">
            {t('footer.risk')}
          </p>
