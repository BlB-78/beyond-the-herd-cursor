/*
  ...
  2. Security
    ...
    - Policies for admin-only modifications
    - Public read access for courses/sections/lessons
    - User-specific access for enrollments/progress/reviews

  3. Features
    - Auto-create profile on signup via trigger
    - Admin helper function for role checking
    - Seed data for demo courses
*/
